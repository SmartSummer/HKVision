...
namespace HkVision
{
    public partial class ChanConfig : Form
    {
        ...
        private void btnImageCfgSet_Click(object sender, EventArgs e)
        {
            ...
            m_struPicCfgV40.sChanName = new byte[1024];
        ...
        private void btnShowStringSet_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                byte[] buffesr = System.Text.Encoding.Unicode.GetBytes(textBoxOSD1.Text);

                m_struShowStrCfg.struStringInfo[0].sString = textBoxOSD1.Text;
                m_struShowStrCfg.struStringInfo[0].wStringSize = (ushort)buffesr.Length;
                //m_struShowStrCfg.struStringInfo[0].sString = textBoxOSD1.Text;
                ...
                buffesr = null;
                buffesr = System.Text.Encoding.Unicode.GetBytes(textBoxOSD2.Text);

                m_struShowStrCfg.struStringInfo[1].sString = textBoxOSD2.Text;
                m_struShowStrCfg.struStringInfo[1].wStringSize = (ushort)buffesr.Length;
                ...
                buffesr = null;
                buffesr = System.Text.Encoding.Unicode.GetBytes(textBoxOSD3.Text);

                m_struShowStrCfg.struStringInfo[2].sString = textBoxOSD3.Text;
                m_struShowStrCfg.struStringInfo[2].wStringSize = (ushort)buffesr.Length;
                ...
                buffesr = null;
                buffesr = System.Text.Encoding.Unicode.GetBytes(textBoxOSD4.Text);

                m_struShowStrCfg.struStringInfo[3].sString = textBoxOSD4.Text;
                m_struShowStrCfg.struStringInfo[3].wStringSize = (ushort)buffesr.Length;
                ...
                buffesr = null;
                buffesr = System.Text.Encoding.Unicode.GetBytes(textBoxOSD5.Text);

                m_struShowStrCfg.struStringInfo[3].sString = textBoxOSD5.Text;
                m_struShowStrCfg.struStringInfo[3].wStringSize = (ushort)buffesr.Length;
                ...
                buffesr = null;
                buffesr = System.Text.Encoding.Unicode.GetBytes(textBoxOSD6.Text);

                m_struShowStrCfg.struStringInfo[3].sString = textBoxOSD6.Text;
                m_struShowStrCfg.struStringInfo[3].wStringSize = (ushort)buffesr.Length;
                ...
                buffesr = null;
                buffesr = System.Text.Encoding.Unicode.GetBytes(textBoxOSD7.Text);

                m_struShowStrCfg.struStringInfo[3].sString = textBoxOSD7.Text;
                m_struShowStrCfg.struStringInfo[3].wStringSize = (ushort)buffesr.Length;
                ...
                buffesr = null;
                buffesr = System.Text.Encoding.Unicode.GetBytes(textBoxOSD8.Text);

                m_struShowStrCfg.struStringInfo[3].sString = textBoxOSD8.Text;
                m_struShowStrCfg.struStringInfo[3].wStringSize = (ushort)buffesr.Length;
                ...
                MessageBox.Show("输入坐标有误" + eee.ToString());
            }
        }
